...
export default function HistoryScreen({ onNavigate, onOpenMenu }: HistoryScreenProps) {
    ...
    const fetchShipments = async () => {
        ...
        try {
            ...
            // Filter for completed shipments (DELIVERED, CANCELLED)
            const completedShipments = response.data.filter((s: Shipment) =>
